...
select customers.LName, customers.FName, employees.LName, employees.FName, sum(orderdetails.totalprice)
from orders
join orderdetails
...
group by customers.LName, customers.FName, employees.LName, employees.FName

having sum(orderdetails.totalprice) > 1000
;
